...
clumpy('bridson_points 1000x500 5 42 pts.npy')
clumpy('cull_points pts.npy potential.npy pts.npy')
clumpy('advect_points pts.npy velocity.npy 0.1 20 anim.npy')
Image.fromarray(np.load("000anim.npy"), "L").show()
Image.fromarray(np.load("019anim.npy"), "L").show()
